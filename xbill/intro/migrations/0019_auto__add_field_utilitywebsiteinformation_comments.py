...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UtilityWebsiteInformation.comments'
        db.add_column(u'intro_utilitywebsiteinformation', 'comments',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UtilityWebsiteInformation.comments'
        db.delete_column(u'intro_utilitywebsiteinformation', 'comments')
