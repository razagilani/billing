...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
         with open(join(dirname(realpath(__file__)),
                  'accounts.csv'), 'r') as csvfile:
            reader = csv.reader(csvfile)
            for name, guid, date in reader:
                try:
                    account = orm.Account.objects.get(guid__iexact=guid)
                except orm.Account.DoesNotExist:
                    ...
                    account.name = name
                    account.tou_signed = None
                    account.tou_version_signed = None
                    account.save()
    ...
    models = {
        ...
        u'intro.account': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'395ea8c1-dd7d-42d5-9c3a-ba6ba29985de'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'intro.user': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'ff77916e-cac5-4d00-acbd-fa8c6960e8bf'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'intro.utilityprovider': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'232d39ee-69aa-465d-bcd2-e071a05ecfb0'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
