...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        for up in orm.UtilityProvider.objects.all():
            up.guid = str(uuid.uuid4())
            up.save()
    ...
    models = {
        ...
        u'intro.account': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'cc8568f2-461f-4688-88a0-aef224073d23'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'intro.user': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'2fe9aae2-0bcf-4271-a568-9394d62e66d8'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'intro.utilityprovider': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'43de0ebf-9b68-4fae-906a-949af008e5ad'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
