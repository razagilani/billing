...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Content.content'
        db.alter_column(u'intro_content', 'content', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Content.content'
        db.alter_column(u'intro_content', 'content', self.gf('django.db.models.fields.TextField')(default='No content found'))
