...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'User.tou_version_signed'
        db.delete_column(u'intro_user', 'tou_version_signed')

        # Adding field 'Account.tou_version_signed'
        db.add_column(u'intro_account', 'tou_version_signed',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=4),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'User.tou_version_signed'
        db.add_column(u'intro_user', 'tou_version_signed',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=4),
                      keep_default=False)

        # Deleting field 'Account.tou_version_signed'
        db.delete_column(u'intro_account', 'tou_version_signed')
