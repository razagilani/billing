...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UtilityWebsiteInformation.created'
        db.add_column(u'intro_utilitywebsiteinformation', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UtilityWebsiteInformation.modified'
        db.add_column(u'intro_utilitywebsiteinformation', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.modified'
        db.add_column(u'intro_user', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.created'
        db.add_column(u'intro_account', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.modified'
        db.add_column(u'intro_account', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UtilityAccountInformation.created'
        db.add_column(u'intro_utilityaccountinformation', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UtilityAccountInformation.modified'
        db.add_column(u'intro_utilityaccountinformation', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UtilityProvider.created'
        db.add_column(u'intro_utilityprovider', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UtilityProvider.modified'
        db.add_column(u'intro_utilityprovider', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UtilityWebsiteInformation.created'
        db.delete_column(u'intro_utilitywebsiteinformation', 'created')

        # Deleting field 'UtilityWebsiteInformation.modified'
        db.delete_column(u'intro_utilitywebsiteinformation', 'modified')

        # Deleting field 'User.modified'
        db.delete_column(u'intro_user', 'modified')

        # Deleting field 'Account.created'
        db.delete_column(u'intro_account', 'created')

        # Deleting field 'Account.modified'
        db.delete_column(u'intro_account', 'modified')

        # Deleting field 'UtilityAccountInformation.created'
        db.delete_column(u'intro_utilityaccountinformation', 'created')

        # Deleting field 'UtilityAccountInformation.modified'
        db.delete_column(u'intro_utilityaccountinformation', 'modified')

        # Deleting field 'UtilityProvider.created'
        db.delete_column(u'intro_utilityprovider', 'created')

        # Deleting field 'UtilityProvider.modified'
        db.delete_column(u'intro_utilityprovider', 'modified')
