...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UtilityWebsiteInformation.account'
        db.delete_column(u'intro_utilitywebsiteinformation', 'account_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UtilityWebsiteInformation.account'
        raise RuntimeError("Cannot reverse this migration. 'UtilityWebsiteInformation.account' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'UtilityWebsiteInformation.account'
        db.add_column(u'intro_utilitywebsiteinformation', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='nothing', to=orm['intro.Account']),
                      keep_default=False)
    ...
    models = {
        ...
        u'intro.account': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'30241c76-4e90-4eb9-bde6-4aa970bf1472'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'intro.user': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'b10fa321-7b36-47da-8a96-ca2afdaad53a'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'intro.utilityprovider': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'ffe39240-6493-4b5c-b3a3-e945fb9812c6'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
