...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UtilityService'
        db.create_table(u'intro_utilityservice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'intro', ['UtilityService'])

        # Adding M2M table for field services on 'UtilityProvider'
        m2m_table_name = db.shorten_name(u'intro_utilityprovider_services')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('utilityprovider', models.ForeignKey(orm[u'intro.utilityprovider'], null=False)),
            ('utilityservice', models.ForeignKey(orm[u'intro.utilityservice'], null=False))
        ))
        db.create_unique(m2m_table_name, ['utilityprovider_id', 'utilityservice_id'])


    def backwards(self, orm):
        # Deleting model 'UtilityService'
        db.delete_table(u'intro_utilityservice')

        # Removing M2M table for field services on 'UtilityProvider'
        db.delete_table(db.shorten_name(u'intro_utilityprovider_services'))
    ...
    models = {
        ...
        u'intro.account': {
            ...
            'tou_version_signed': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '4'})
        },
        u'intro.address': {
        ...
        u'intro.utilityprovider': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['intro.UtilityService']", 'symmetrical': 'False'}),
