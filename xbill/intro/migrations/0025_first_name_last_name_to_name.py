...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        for account in orm.Account.objects.all():
            account.name = ' '.join([x for x in [
                account.first_name, account.last_name] if x is not None])
            print account.first_name, '+', account.last_name, '->', account.name
            account.save()

    def backwards(self, orm):
        for account in orm.Account.objects.all():
            try:
                account.first_name, account.last_name = account.name.split(" ", 1)
            except ValueError:
                account.first_name, account.last_name = account.name, ""
            account.save()
    ...
    models = {
        ...
        u'intro.account': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'02378e6c-3082-48e5-8bb6-5f030bc2c286'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'intro.user': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'59bc8da2-cf47-49fb-bfc1-24e3f8a2447e'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'intro.utilityprovider': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'a474475a-d155-437a-9eab-8e5b16dbfa8c'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
