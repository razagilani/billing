...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        for uwi in orm.UtilityWebsiteInformation.objects.all():
            acc = uwi.account
            uwi.accounts.add(acc)

    def backwards(self, orm):
        for uwi in orm.UtilityWebsiteInformation.objects.all():
            accs = uwi.accounts.all()
            if len(accs) >= 1:
                uwi.account = accs[0]
                uwi.save()
    ...
    models = {
        ...
        u'intro.account': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'15fbc2bb-4cf4-4a67-a420-7e522eac2652'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'intro.user': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'b9a9a997-8130-4fc4-8ce4-581f93bf2f5b'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'intro.utilityprovider': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'be210423-250a-4369-8833-0839491d23d4'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
