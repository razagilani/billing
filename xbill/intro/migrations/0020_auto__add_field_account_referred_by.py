...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.referred_by'
        db.add_column(u'intro_account', 'referred_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='referred', null=True, to=orm['affiliates.Affiliate']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.referred_by'
        db.delete_column(u'intro_account', 'referred_by_id')
