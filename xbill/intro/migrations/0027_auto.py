...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field accounts on 'UtilityWebsiteInformation'
        m2m_table_name = db.shorten_name(u'intro_utilitywebsiteinformation_accounts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('utilitywebsiteinformation', models.ForeignKey(orm[u'intro.utilitywebsiteinformation'], null=False)),
            ('account', models.ForeignKey(orm[u'intro.account'], null=False))
        ))
        db.create_unique(m2m_table_name, ['utilitywebsiteinformation_id', 'account_id'])


    def backwards(self, orm):
        # Removing M2M table for field accounts on 'UtilityWebsiteInformation'
        db.delete_table(db.shorten_name(u'intro_utilitywebsiteinformation_accounts'))
    ...
    models = {
        ...
        u'intro.account': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'2e81aa4c-72db-4b25-a567-d92152b773e0'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'intro.user': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'e33333f7-ab19-49da-acea-4fd1b70e872b'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'intro.utilityprovider': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'4efc807f-278f-4461-858e-432360e0623f'", 'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'intro.utilitywebsiteinformation': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'nothing'", 'to': u"orm['intro.Account']"}),
