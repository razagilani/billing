...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.tou_version_signed'
        db.alter_column(u'intro_account', 'tou_version_signed', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Account.tou_version_signed'
        db.alter_column(u'intro_account', 'tou_version_signed', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
