...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Content.modified_by'
        db.add_column(u'intro_content', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['intro.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Content.modified_by'
        db.delete_column(u'intro_content', 'modified_by_id')
