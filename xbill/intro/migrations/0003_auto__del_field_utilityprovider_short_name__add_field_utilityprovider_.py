...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UtilityProvider.short_name'
        db.delete_column(u'intro_utilityprovider', 'short_name')

        # Adding field 'UtilityProvider.display_name'
        db.add_column(u'intro_utilityprovider', 'display_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UtilityProvider.short_name'
        db.add_column(u'intro_utilityprovider', 'short_name',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UtilityProvider.display_name'
        db.delete_column(u'intro_utilityprovider', 'display_name')
