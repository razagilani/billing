...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.tandc1_signed'
        db.alter_column(u'intro_account', 'tandc1_signed', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Adding field 'UtilityProvider.state'
        db.add_column(u'intro_utilityprovider', 'state',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['intro.State'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Account.tandc1_signed'
        db.alter_column(u'intro_account', 'tandc1_signed', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
        # Deleting field 'UtilityProvider.state'
        db.delete_column(u'intro_utilityprovider', 'state_id')
