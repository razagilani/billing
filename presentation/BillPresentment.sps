...
<structure version="9" htmlmode="strict" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1">
	...
	<schemasources>
		...
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="C:\workspace-skyline\billing\UtilityBill.xsd" workingxmlfile="C:\workspace-skyline\billing\sample\Skyline-1-10001.xml">
				<xmltablesupport/>
				<textstateicons/>
			</xsdschemasource>
		</schemasources>
																					...
																					<paragraph>
																						<children>
																							<text fixtext="Guaranteed Savings through Green Energy">
																								<styles color="#0c743c" font-family="Arial" font-size="25px" font-style="normal" font-weight="normal"/>
																							</text>
																						</children>
																					</paragraph>
																				</children>
