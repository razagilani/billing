...
# NOTE constraints that were removed by "create table ... like" (customer id,
# utilbill id, rebill id) are re-added in 03_rename.py because columns can't be
# renamed without constraints
