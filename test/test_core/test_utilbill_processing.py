...
class UtilbillProcessingTest(TestCaseWithSetup, testing_utils.TestCase):
    ...
    def test_create_new_account(self):
        ...
        self.assertEqual(([], 0), self.utilbill_views.get_all_utilbills_json('88888',
                                                                    0, 30))
        ...
        self.utilbill_processor.upload_utility_bill('88888', StringIO('January 2013'),
                                         ...
                                         'gas')
        utilbills_data = self.utilbill_views.get_all_utilbills_json('88888',
                                                             0, 30)[0]
        ...
        ubdata = self.utilbill_views.get_all_utilbills_json('88888', 0, 30)[0][0]
    ...
    def test_update_utilbill_metadata(self):
        ...
        doc = self.utilbill_views.get_all_utilbills_json('99999', 0, 30)[0][0]
    ...
    def test_upload_utility_bill(self):
        ...
        utilbills_data, count = self.utilbill_views.get_all_utilbills_json(account,
                                                                    0, 30)
        ...
        # check charges
        charges = self.utilbill_views.get_utilbill_charges_json(
            utilbills_data[0]['id'])
        ...
        self.utilbill_processor.upload_utility_bill(account, file2, date(2012, 2, 1),
                                         ...
                                         utility='pepco',
                                         supplier='supplier')
        utilbills_data, _ = self.utilbill_views.get_all_utilbills_json(account, 0, 30)
        dictionaries = [{
                            'state': 'Final',
                            'service': 'Electric',
                            'utility': self.utilbill_views.
        ...
        self.utilbill_processor.upload_utility_bill(account, None, date(2012, 3, 1),
                                         ...
                                         supplier='supplier')
        utilbills_data, _ = self.utilbill_views.get_all_utilbills_json(account, 0,
                                                                30)
        dictionaries = [{
                            'state': 'Estimated',
                            'service': 'Gas',
        ...
        _, count = self.utilbill_views.get_all_utilbills_json(account, 0, 30)
    ...
    def test_create_utility_bill_for_existing_file(self):
        ...
        data, count = self.utilbill_views.get_all_utilbills_json(account, 0, 30)
        self.assertEqual(1, count)
        self.assertDictContainsSubset({
            'state': 'Final',
            'service': 'Electric',
    ...
    def test_rs_prediction(self):
        ...
        id_a = next(obj['id'] for obj in
                    self.utilbill_views.get_all_utilbills_json(
            acc_a, 0, 30)[0])
        ...
        self.utilbill_processor.upload_utility_bill(acc_a, StringIO('February 2000 A'),
                                         ...
                                         'gas', total=0,
                                         state=UtilBill.Complete)
        id_a_2 = [obj for obj in self.utilbill_views.get_all_utilbills_json(
            acc_a, 0, 30)][0][0]['id']

        # initially there will be no RSIs in A's 2nd utility bill, because
        # there are no "processed" utility bills yet.
        self.assertEqual([], self.utilbill_views.get_utilbill_charges_json(id_a_2))
        ...
        self.assertEqual(set(['DISTRIBUTION_CHARGE', 'PGC', 'NOT_SHARED']),
                         set(r['rsi_binding'] for r in
                             self.utilbill_views.get_utilbill_charges_json(id_a_2)))
    ...
    def test_compute_utility_bill(self):
        ...
        charges = self.utilbill_views.get_utilbill_charges_json(utilbill_data['id'])
    ...
    def test_compute_realistic_charges(self):
        ...
        actual_charges = self.utilbill_views.get_utilbill_charges_json(utilbill_id)
