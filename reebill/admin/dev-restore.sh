...
scp DEVELOPERNAMESNEVERGOINSCRIPTSDIEDIEDIE@tyrell:/tmp/${now}billing_mysql.dmp /tmp
...
scp -r DEVELOPERNAMESNEVERGOINSCRIPTSDIEDIEDIE@tyrell:/tmp/${now}ratestructure_mongo /tmp
scp -r DEVELOPERNAMESNEVERGOINSCRIPTSDIEDIEDIE@tyrell:/tmp/${now}reebills_mongo /tmp
scp -r DEVELOPERNAMESNEVERGOINSCRIPTSDIEDIEDIE@tyrell:/tmp/${now}journal_mongo /tmp
scp -r DEVELOPERNAMESNEVERGOINSCRIPTSDIEDIEDIE@tyrell:/tmp/${now}eventlog_mongo /tmp
scp -r DEVELOPERNAMESNEVERGOINSCRIPTSDIEDIEDIE@tyrell:/tmp/${now}users_mongo /tmp
...
#rm -rf /db-dev/
#scp -r DEVELOPERNAMESNEVERGOINSCRIPTSDIEDIEDIE@tyrell:/db-stage /db-dev
