...
# compress
tar czvf ${now}reebill-prod.tar.z /db-prod ${now}ratestructure_mongo ${now}reebills_mongo ${now}nexus_mongo ${now}users_mongo ${now}billing_mysql.dmp ${now}journal_mongo ${now}eventlog_mongo 
