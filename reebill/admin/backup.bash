...
mongodump --db skyline-prod --collection users --out ${now}reebills_users
mongodump --db nexus --collection skyline --out ${now}nexus_mongo

# compress
tar czvf ${now}reebill-prod.tar.z /db-prod ${now}ratestructure_mongo ${now}reebills_mongo ${now}nexus_mongo ${now}users_mongo
