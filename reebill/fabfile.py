...
def prepare_deploy():
    ...
    fabops.local('tar czvf /tmp/bill_framework_code.tar.z ../nexus_util.py ../bill.py ../__init__.py ../processing/process.py ../processing/__init__.py ../processing/state.py ../processing/fetch_bill_data.py ../processing/rate_structure.py ../processing/billupload.py ../mutable_named_tuple.py ../nexus_util.py ../json_util.py')
