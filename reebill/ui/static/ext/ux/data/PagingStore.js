...
Ext.define('Ext.ux.data.PagingStore', {
	...
	loadRecords: function (records, options) {
        console.log('loadRecords', records, options);
		var me = this,
			i = 0,
	...
	loadData: function (data, append) {
        console.log('loadData', data, append);
		var me = this,
			model = me.model,
			length = data.length,
			newData = [],
	...
	loadRawData: function (data, append) {
        console.log('loadRawData', data, append);
		var me = this,
	...
	insert: function (index, records) {
        console.log('insert', index, records);
		var me = this,
			sync = false,
			i,
			record,
    ...
    remove: function(records, /* private */ isMove, silent) {
        ...
        for (; i < length; i++) {
            ...
            if (me.allData) {
                console.log(data.getAt(index) === me.allData.getAt(index));
				me.allData.remove(record);
			}

			if (me.snapshot) {
			    console.log(data.getAt(index) === me.snapshot.getAt(index));
	...
	clearFilter: function (suppressEvent) {
        console.log('clearFilter', suppressEvent);
		var me = this;
	...
	removeAll: function (silent) {
        ...
        if (allData) {
            allData.removeAll(data.getRange());
        }

        me.clearData(silent);
	},

    clearData: function(silent){
        console.log('clearData', silent);
        var me = this,
            data = me.data;
    ...
    resetAllData: function(){
        ...
        var me = this;
        if (me.initOptions === undefined){
            me.initOptions = me.lastOptions;
        }
