...
def upgrade():
    ...
    op.add_column('reebill_customer', sa.Column('billing_address_id', sa.Integer(), nullable=False))
    op.add_column('reebill_customer', sa.Column('service_address_id', sa.Integer(), nullable=False))
