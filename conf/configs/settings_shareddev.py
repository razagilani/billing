...
DATABASES = {
    'default': {
        ...
        'NAME': 'billing_dev', # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'billing_dev',
        'PASSWORD': 'billing_dev',
        'HOST': 'postgres-dev.nextility.net', # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
...
ALLOWED_HOSTS = ['xbill-dev.nextility.net']
...
TEMPLATE_DIRS = (
    ...
    SITE_ROOT+"/../django/contrib/admin/templates/",
)
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'info@nextility.com'
EMAIL_HOST_PASSWORD = 'SgLpLj0QjZyDh6ra'
EMAIL_USE_TLS = True
EMAILER = {
    ...
    'imap_port' : 993,
    'originator' : 'info@nextility.com',
    'from' : '"Info (dev)" <info@nextility.com>',
    'bcc_list' : [],
    'password' : 'SgLpLj0QjZyDh6ra',
    'delivery_confirmation_recipient' : 'info@nextility.com',
...
# ETL CONFIGURATION
XBILL_ETL_DIR = '/home/xbill-dev/etl-dir/'
